...
function brandNav(activeVibe) {
  ...
  const sub = `<div class="sub"><div class="si"><a class="sl" href="/crabox.html">🦀 crabox.ai ▾</a><a href="#roadmap">🎓 학습 로드맵</a><a href="/play.html">⚡ STUDY RUSH</a><a href="/genai.html"${activeVibe ? ' class="on"' : ''}>🤖 생성형 AI</a></div></div>`;
  return `${STYLE}<nav id="dpnav"><div class="in"><a class="bd" href="/">DataPD</a>${links}</div>${sub}</nav>`;
}
